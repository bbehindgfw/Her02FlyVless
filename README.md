## 通过ws传输的 (VMess和VLESS)两种协议部署高性能代理服务
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/bbehindgfw/Her02FlyVless) 
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 默认协议密码为`8831e13f-7078-4350-b9cd-24591ed16e9b`，路径为`/ray`
...
| UUID     | 8831e13f-7078-4350-b9cd-24591ed16e9b| [uuid在线生成器](https://www.uuidgenerator.net "uuid在线生成器") `务必替换`                       |
...
* 端口：443
* 默认UUID：8831e13f-7078-4350-b9cd-24591ed16e9b
* vmess额外id：0
* 加密：auto
* 传输协议：ws
* 伪装类型：none
